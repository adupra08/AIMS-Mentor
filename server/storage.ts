  ...
  async seedOpportunities(): Promise<void> {
    const seedData = [
      ...
      },
      {
        ...
        eligibleGrades: [9, 10, 11, 12],
        subjects: ["Computer Science", "AI", "Technology"],
        deadline: new Date("2025-12-31"),
        ...
        isPaid: false,
        difficultyLevel: "beginner",
        tags: ["IBM", "AI", "Free", "Direct"]
      },
      {
        title: "Microsoft Azure Fundamentals (AZ-900)",
        description: "Official Microsoft certification for cloud basics. High school students can claim a free exam voucher through the Microsoft Student Hub.",
        category: "certification",
        eligibleGrades: [9, 10, 11, 12],
        ...
        isPaid: false,
        difficultyLevel: "beginner",
        tags: ["Microsoft", "Azure", "Free", "Direct"]
      },
      {
        title: "Google Fundamentals of Digital Marketing",
        description: "Free certification from Google Digital Garage. Comprehensive 40-hour course on digital business and marketing strategies.",
        category: "certification",
        eligibleGrades: [9, 10, 11, 12],
        subjects: ["Business", "Marketing", "Technology"],
        deadline: new Date("2025-12-31"),
        applicationUrl: "https://learndigital.withgoogle.com/digitalgarage/course/digital-marketing",
        isTeamBased: false,
        location: "Online",
        isPaid: false,
        difficultyLevel: "beginner",
        tags: ["Google", "Marketing", "Free", "Direct"]
      },
      {
        title: "Google Analytics 4 Certification",
        description: "Official Google Skillshop certification. Master the latest version of Google Analytics to measure website performance.",
        category: "certification",
        eligibleGrades: [10, 11, 12],
        subjects: ["Business", "Technology", "Data Analysis"],
        deadline: new Date("2025-12-31"),
        applicationUrl: "https://skillshop.withgoogle.com/search?q=GA4",
        isTeamBased: false,
        location: "Online",
        isPaid: false,
        difficultyLevel: "intermediate",
        tags: ["Google", "Analytics", "Free", "Skillshop"]
      },
      {
